    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, default='profile_pictures/profile.png', null=True, upload_to='profile_pictures/', verbose_name='Profile Picture')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('MC', 'Multiple Choice'), ('TF', 'True/False'), ('ID', 'Identification')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classes', models.ManyToManyField(related_name='quizzes', to='api.class')),
                ('questions', models.ManyToManyField(to='api.questionbank')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
